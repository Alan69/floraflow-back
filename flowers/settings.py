...
HALYK_CLIENT_ID = config('HALYK_CLIENT_ID'),
HALYK_CLIENT_SECRET = config('HALYK_CLIENT_SECRET'),
HALYK_TERMINAL_ID = config('HALYK_TERMINAL_ID'),
HALYK_SHOP_ID = config('HALYK_SHOP_ID'),